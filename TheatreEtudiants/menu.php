...
<h1>Bienvenue dans l’application Théâtre !</h1>
      ...
      <ul class="menu">
        ...
        <li><a href="DetailsRepresentation.php">Details Des Representations  </a> </li>
      </ul>
      ...
      <ul class="menu">
         ...
         <li><a href="CategorieTicket.php">interface utilisateur amelioree<br /></a></li>
      </ul>
...
<li><a href="GererRepresentations.php">Gérer les représentations</a></li>
      ...
      <h2> Mon Travail </h2>
      <ul class="menu">
         <li><a href="Mise_A_Jours.php"> Mise a jours de ma base de donnee  </a> </li>
      </ul>
